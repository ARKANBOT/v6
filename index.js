...
Lexxy.sendMessage(from, bf, image, { quoted: flexx, caption: 'Logo By FGZ Official' })
break
case 'kaneki':
case 'rem':
case 'lolimaker':
...
fakethumb(buffer,'By fgz Official')
fs.unlinkSync(ran)
})
break
case 'searchgrup':
